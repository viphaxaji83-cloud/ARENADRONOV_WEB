      ...
      <Card className="border-accent/20 p-8 shadow-glow sm:p-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-fg-secondary">
            Заявки на турниры, рейтинг сезона и профиль на платформе
          </p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <Field
            ...
            required
            hint="Латиница, цифры и _. Будет использоваться в URL."
          >
          ...
          <label className="flex cursor-pointer items-start gap-2.5 text-xs text-fg-secondary">
            <input
              type="checkbox"
              className="mt-0.5 h-4 w-4 rounded accent-[hsl(var(--color-accent))]"
            />
            <span>
              Я принимаю{" "}
